...
public class HtmlAnomaliesPage extends HtmlFormatter
{
	...
	public void write(Database database, Collection<Table> tables, List<? extends ForeignKeyConstraint> impliedConstraints, boolean hasOrphans, LineWriter out)
			throws IOException
	{
	...
	private void writeHeader(Database database, boolean hasOrphans, LineWriter html) throws IOException
	{
		...
		html.writeln("  <tr><td class='container' align='center' valign='top' colspan='2'><a href='" + Config.getInstance().getWebsiteURL()
				+ "' target='_blank'><img src='" + Config.getInstance().getLogoURL() + "' alt='" + Config.getInstance().getCompanyName()
				+ "' border='0' height='60'></a></td></tr>");
		html.writeln("<tr>");
