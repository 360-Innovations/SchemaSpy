...
public class HtmlConstraintsPage extends HtmlFormatter
{
	...
	public void write(Database database, List<ForeignKeyConstraint> constraints, Collection<Table> tables, boolean hasOrphans, LineWriter html)
			throws IOException
	{
	...
	private void writeForeignKeyConstraints(List<ForeignKeyConstraint> constraints, LineWriter html) throws IOException
	{
		...
		html.writeln("<table>");
		html.writeln("  <tr><td class='container' align='right' valign='top'><a href='" + Config.getInstance().getWebsiteURL() + "' target='_blank'><img src='"
